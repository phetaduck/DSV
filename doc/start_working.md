...
variable, then it will be compiled to DSV target.

## Change the name of the executable

### Manual proces:

* **packaging/DSV.desktop.desktop** - rename file, change texts, replace "DSV" strings with your new executable name
* **packaging/DSV.ico** - rename file
* **packaging/DSV.icon.in.rc** - rename file, replace "DSV" strings with your new executable name
* **packaging/DSV.png** - rename file
* **packaging/CMakeLists.txt** - change description texts, windows desktop icon name (CPACK_NSIS_DISPLAY_NAME), replace "DSV" strings with your new executable name
* **test/CMakeLists.txt** - replace "DSV" strings with your new executable name
* **readme.md** - replace "DSV" strings with your new executable name
* **source/CMakeLists.txt** - replace "DSV" strings with your new executable name
* **doc/start_working.md** - replace "DSV" strings with your new executable name
* **doc/directoryStructure.md** - replace "DSV" strings with your new executable name
...
editor) and replace all occurences of DSV with your new name.

~~~bash
cd [root/of/project]
export NEWNAME="newExecutableName"

git mv packaging/DSV.desktop    packaging/${NEWNAME}.desktop
git mv packaging/DSV.ico        packaging/${NEWNAME}.ico
git mv packaging/DSV.icon.in.rc packaging/${NEWNAME}.icon.in.rc 
git mv packaging/DSV.png        packaging/${NEWNAME}.png

ag -l DSV | xargs sed -i -e "s/DSV/${NEWNAME}/g"
~~~
...
Just change replace packaging/DSV.ico and packaging/DSV.png with
your own images.
